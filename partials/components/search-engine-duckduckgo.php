<div class="search-engine-wrapper search-engine-wrapper--duckduckgo">
	<form role="search" method="get" class="searchform"
	      action="<?php echo esc_url( home_url( '/' ) ); ?>" target="_blank">
		<div class="search-engine-form-group">
			<div class="search-engine-wrapper__duckduckgo-icon">
				<img src="<?php echo UTILS()->get_image_uri() . '/duckduck-icon.svg' ?>" alt=""/>
			</div>
			<label class="screen-reader-text" for="s"><?php pll_esc_html_e( 'Hae Duckduckgosta' ); ?></label>
		...
		<input type="hidden" name="engine" value="duckduckgo">
	</form>
</div>
